...
components: list[Component] = [
    Component("J1", "DC barrel jack panel header 5.5x2.5", "CONN_2", 28, 34, {"1": "+19V_RAW", "2": "GND_RAW"}, fields={"Function": "DC barrel jack 5.5x2.5", "Pinout": "1=center, 2=sleeve"}),
    ...
    Component("TVS1", "SMBJ20A TVS", "D_2PIN", 138, 54, {"1": "+19V", "2": "GND_STAR"}),
    ...
    Component("J2", "3.5 mm TRS input panel header", "CONN_3_TRS", 30, 104, {"1": "IN_L", "2": "IN_R", "3": "GND_SIG"}, fields={"Function": "3.5 mm TRS input jack", "Pinout": "Tip=IN_L, Ring=IN_R, Sleeve=GND_SIG"}),
    Component("RV1", "Dual-gang 10 k log tactile volume panel header", "POT_DUAL_HEADER", 86, 104, {"1": "IN_L", "2": "TACT_INL", "3": "GND_SIG", "4": "IN_R", "5": "TACT_INR", "6": "GND_SIG"}, fields={"Function": "Tactile volume, dual-gang 10k log", "Wiring": "top=input, wiper=output, bottom=GND_SIG"}),
    Component("RV2", "Dual-gang 10 k log headphone volume panel header", "POT_DUAL_HEADER", 86, 144, {"1": "IN_L", "2": "HP_INL", "3": "GND_SIG", "4": "IN_R", "5": "HP_INR", "6": "GND_SIG"}, fields={"Function": "Headphone volume, dual-gang 10k log", "Wiring": "top=input, wiper=output, bottom=GND_SIG"}),
    ...
    Component("J3", "4-pole Speakon/XLR panel header", "CONN_4", 292, 104, {"1": "OUTL+", "2": "OUTL−", "3": "OUTR+", "4": "OUTR−"}, fields={"Function": "4-pole Speakon/XLR tactile output", "Pinout": "1+=OUTL+, 1-=OUTL−, 2+=OUTR+, 2-=OUTR−"}),
    ...
    Component("U1", "TLE2426 rail splitter", "TLE2426_3PIN", 236, 82, {"1": "+19V_HP", "2": "GND_SIG", "3": "VGND"}, fields={"Function": "Virtual ground rail splitter"}),
    ...
    Component("R2", "100k L input bias to VGND", "R_2PIN", 176, 156, {"1": "A2_INL_BIAS", "2": "VGND"}),
    Component("R3", "100k R input bias to VGND", "R_2PIN", 176, 184, {"1": "A2_INR_BIAS", "2": "VGND"}),
    ...
    Component("C11", "470uF/25V L output coupling", "CP_2PIN", 382, 150, {"1": "HP_L_SER", "2": "HP_OUT_L"}),
    Component("C12", "470uF/25V R output coupling", "CP_2PIN", 382, 184, {"1": "HP_R_SER", "2": "HP_OUT_R"}),
    Component("J4", "3.5 mm TRS headphone panel header", "CONN_3_TRS", 414, 168, {"1": "HP_OUT_L", "2": "HP_OUT_R", "3": "GND_SIG"}, fields={"Function": "3.5 mm TRS headphone output jack", "Pinout": "Tip=HP_OUT_L, Ring=HP_OUT_R, Sleeve=GND_SIG"}),
...
def schematic() -> str:
    ...
    parts.extend(
        [
            ...
            text_block("Headphone output is AC-coupled: J4 sleeve connects to GND_SIG, not VGND.", 20, 222, 1.05),
